== Description ==
'Losungen for Conky' is a small program that shows daily Bible verses in German from the Moravian church (Herrnhuter Brüdergemeine). 
...
3. Configure your file .conkyrc: 
	a) Add the following line to the configuration section (before the line TEXT)
		text_buffer_size 768
           This will tell Conky to show the whole text.
	b) Add a call of losung.pl to the TEXT section (after the line TEXT) at the desired position. You can find hints and templates to copy in the file conky-example-rc.
